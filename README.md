...
Estas credenciales son únicamente para desarrollo y deben modificarse antes de desplegar la aplicación.
...
```text
scripts/database/clean-demo-data.sql
```

Este script permite limpiar datos de demostración durante el desarrollo.
