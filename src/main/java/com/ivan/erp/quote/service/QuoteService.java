...
public class QuoteService {
    ...
    private QuoteLine buildLine(QuoteLineForm form) {
        ...
        if (form.getProductId() != null) {
            product = productRepository.findByIdAndEnabledTrue(form.getProductId())
                    .orElseThrow(() -> new IllegalStateException("El producto no existe o está desactivado"));
        }
    ...
    private Client getClient(Long clientId) {
        return clientRepository.findByIdAndEnabledTrue(clientId)
                .orElseThrow(() -> new IllegalStateException("El cliente no existe o está desactivado"));
    }
