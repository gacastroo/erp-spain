...
public interface PaymentRepository extends JpaRepository<Payment, Long> {
    ...
    @Query("""
            ...
            WHERE p.invoice.id = :invoiceId
            """)
    LocalDate findLatestPaymentDateByInvoiceId(@Param("invoiceId") Long invoiceId);
    ...
    @Query("""
            ...
            """)
    List<Object[]> sumAmountsByInvoiceIds(@Param("invoiceIds") java.util.Collection<Long> invoiceIds);
