...
public class ExpenseForm {
    ...
    @Digits(integer = 10, fraction = 2, message = "La base no puede superar 10 enteros y 2 decimales")
    ...
    @Digits(integer = 3, fraction = 2, message = "El IVA no puede superar 3 enteros y 2 decimales")
