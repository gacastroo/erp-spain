...
public class ExpenseController {
    ...
    public String index(
        ...
        Page<Expense> expenses = expenseService.search(query, page, size);
        model.addAttribute("expenses", expenses);
        model.addAttribute("query", query);
        PaginationSupport.addToModel(model, expenses, size);
    ...
    public String create(
        ...
        try {
            ...
            bindingResult.reject("expense.error", ex.getMessage());
            prepareFormModel(model, expenseForm, "Nuevo gasto", "/expenses");
            return "expenses/form";
        }
    }
