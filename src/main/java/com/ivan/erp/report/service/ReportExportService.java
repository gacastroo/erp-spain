...
public class ReportExportService {
    ...
    public byte[] toPdf(ReportData reportData) {
        ...
        try (ByteArrayOutputStream outputStream = new ByteArrayOutputStream()) {
            ...
            addPdfRow(summaryTable, "Gastos registrados", formatMoney(reportData.expensesTotal()));
            addPdfRow(summaryTable, "Gastos pagados", formatMoney(reportData.paidExpensesTotal()));
    ...
    private void writeSummary(Sheet sheet, ReportData reportData, Company company, CellStyle moneyStyle) {
        ...
        writeMetric(sheet, rowIndex++, "Gastos registrados", reportData.expensesTotal(), moneyStyle);
        writeMetric(sheet, rowIndex++, "Gastos pagados", reportData.paidExpensesTotal(), moneyStyle);
